         ...
         <main role="main" class="inner cover">
            <?php
               ...
               try {
                  ...
                  $createaccountquery = $conn->prepare("INSERT INTO datatable (name, fhname, age, education, email, phone, address, business, hmt, addiction, entrydate, gurumantra) VALUES (?,?,?,?,?,?,?,?,?,?,current_time(),?)");
                  $createaccountquery->execute(array($name,$fhname,$age,$education,$email,$phone,$finaladdress,$business,$hmt,$addiction,$gurumantra));
                  $conn=null;
                  $valid=true;
                  ...
                  header("Location: dataentry.php?success=0");
                  exit;             
                }
